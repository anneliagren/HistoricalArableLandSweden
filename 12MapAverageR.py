...
folder_path_R = '/workspace/data/AllMapsInOneFolder/decompressed/geokeyed/Red'
folder_path = '/workspace/data/AllMapsInOneFolder/decompressed/geokeyed/'

# Create output folder
output_AverageR_folder = os.path.join(folder_path, 'AverageR')

# Ensure output folder exists
os.makedirs(output_AverageR_folder, exist_ok=True)

# Use os.listdir to get all files in the directory
files_in_directory = os.listdir(folder_path_R)
...
for tif_file in tif_files:
    file_path = os.path.join(folder_path_R, tif_file)
    ...
    with rasterio.open(file_path) as src:
        ...
        output_file_path = os.path.join(output_AverageR_folder, tif_file)
