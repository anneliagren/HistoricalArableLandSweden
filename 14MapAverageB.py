...
folder_path_B = '/workspace/data/AllMapsInOneFolder/decompressed/geokeyed/Blue'
folder_path = '/workspace/data/AllMapsInOneFolder/decompressed/geokeyed/'

# Create output folder
output_AverageB_folder = os.path.join(folder_path, 'AverageB')

# Ensure output folder exists
os.makedirs(output_AverageB_folder, exist_ok=True)

# Use os.listdir to get all files in the directory
files_in_directory = os.listdir(folder_path_B)
...
for tif_file in tif_files:
    file_path = os.path.join(folder_path_B, tif_file)
    ...
    with rasterio.open(file_path) as src:
        ...
        output_file_path = os.path.join(output_AverageB_folder, tif_file)
