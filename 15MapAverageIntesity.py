...
folder_path_Intensity = '/workspace/data/AllMapsInOneFolder/decompressed/geokeyed/Intensity/'
folder_path = '/workspace/data/AllMapsInOneFolder/decompressed/geokeyed/'

# Create output folder
output_AverageIntensity_folder = os.path.join(folder_path, 'AverageI')

# Ensure output folder exists
os.makedirs(output_AverageIntensity_folder, exist_ok=True)

# Use os.listdir to get all files in the directory
files_in_directory = os.listdir(folder_path_Intensity)
...
for tif_file in tif_files:
    file_path = os.path.join(folder_path_Intensity, tif_file)
    ...
    with rasterio.open(file_path) as src:
        ...
        output_file_path = os.path.join(output_AverageIntensity_folder, tif_file)
